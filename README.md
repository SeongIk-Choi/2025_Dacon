...
collecting and curating ASK1-related datasets
preprocessing SMILES strings and activity labels
conducting regression experiments and model comparisons
training the final tuned prediction model
performing inference on unseen molecules
---
